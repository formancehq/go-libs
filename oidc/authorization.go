...
type AuthRequest struct {
	...
	// extends the AuthRequest with custom parameters
	OrganizationID string   `json:"organization_id" schema:"organization_id"`
	ConnectorID    string   `json:"connector_id" schema:"connector_id"`
	Resources      []string `json:"resource" schema:"resource"`
}
...
func (r *AuthRequest) GetResponseType() ResponseType {
...
func (r *AuthRequest) GetResponseMode() ResponseMode {
